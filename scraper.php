<?php
# Auburn City Council scraper - ePathway
...
###
$url_base = "https://secure.auburn.nsw.gov.au/ePathway/Production/Web/GeneralEnquiry/";
$term_url = "https://secure.auburn.nsw.gov.au/ePathway/Production/Web/GeneralEnquiry/EnquiryLists.aspx";

$da_page = $url_base . "EnquirySummaryView.aspx";
$comment_base = "mailto:auburncouncil@auburn.nsw.gov.au?subject=Number ";

$cookies = accept_terms_get_cookies($term_url);
